...
def vgg16_model(input_shape, n_class=10):
    ...
    conv14=Conv2D(64, (3, 3),activation='relu', padding="same")(conv9)
    conv14=UpSampling2D(size=(2, 2))(conv14)
    conv14=Conv2D(32, (3, 3),activation='relu', padding="same")(conv14)
    conv14=UpSampling2D(size=(2, 2))(conv14)
    conv14=Conv2D(16, (3, 3),activation='relu', padding="same")(conv14)
    conv14=UpSampling2D(size=(2, 2))(conv14)
    
    conv_out=Conv2D(3, (3, 3), padding="same",activation='sigmoid', name="conv_out")(conv14)
...
for j in range(20):
    model, history = train(model=model, data=((X_train, Y_train), (X_test, Y_test)), epoch_size=10)
